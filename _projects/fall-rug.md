...
![Fabrics for the new rug]({{ img-path }}/reboot-fabric.jpg){: .center-image }
...
## Project plan
![Project plan](/assets/img/{{ page.folder }}/project-plan.jpg){: .center-image }

## New fabric

### Solid stripes
* Purpe w/border = 15.21 g/sqft = 1 inch strips
![Purple fabric with border](/assets/img/{{ page.folder }}/purple-wborder.jpg){: .center-image }<br />
* Orange fans = 16.26 g/sqft = 1 inch strips
![Fabric with orange fans](/assets/img/{{ page.folder }}/orange-fans.jpg){: .center-image }<br />

### Patterned stripes
* Orange-green vines = 11.80 g/sqft = 1.25 inch strips
![Fabric with orange and green vines](/assets/img/{{ page.folder }}/orange-green-vines.jpg){: .center-image }<br />
* Medallions = 11.58 g/sqft = 1.25 inch strips
![Fabric with orange, green, and purple medallions]({/assets/img/{{ page.folder }}/medallions.jpg){: .center-image }<br />
* Green ferns = 16.54 g/sqft = 1 inch strips
![Fabric with green ferns](/assets/img/{{ page.folder }}/green-ferns.jpg){: .center-image }<br />
* Gold curlicues = 15.51 g/sqft = 1 inch strips
![Fabric with gold medallions](/assets/img/{{ page.folder }}/gold-curlicues.jpg){: .center-image }<br />
	
### Rosepath
* Orange medallions = 12.07 g/sqft = 1.25 inch strips
![Fabric with orange medallions](/assets/img/{{ page.folder }}/orange-medallions.jpg){: .center-image }<br />
* Purple ovals = 15.41 g/sqft = 1 inch strips
![Fabric with purple ovals](/assets/img/{{ page.folder }}/purple-ovals.jpg){: .center-image }<br />
