...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.0.5"])
      ...
      s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, ["= 1.4.0"])
      s.add_runtime_dependency(%q<jekyll-github-metadata>.freeze, ["= 1.11.1"])
      ...
      s.add_dependency(%q<jekyll>.freeze, ["= 3.0.5"])
      ...
      s.add_dependency(%q<jekyll-seo-tag>.freeze, ["= 1.4.0"])
      s.add_dependency(%q<jekyll-github-metadata>.freeze, ["= 1.11.1"])
